/*
  ...
  // avrdude -c linuxgpio -C /etc/avrdude.conf -p m328p -U lfuse:w:0xFF:m -U hfuse:w:0xDE:m -U efuse:w:0x05:m -Uflash:w:/tmp/sketch.hex:i -q
*/
...
void loop() {
  ...
  for ( int i = +2; i >= -2; i--) {
    ...
    LoRa.setFrequency(sweep);
    Console.print("Sweep Freq: ");
